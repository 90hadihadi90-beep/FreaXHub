...
local ScriptVeritabani = {
    {Isim = "Infinite Yield Admin (En Güncel Sürüm)", Komut = "loadstring(game:HttpGet('https://raw.githubusercontent.com/EdgeY/infiniteyield/master/source'))()", Kategori = "Genel"},
    {Isim = "CMD-X Powerful Admin Panel", Komut = "loadstring(game:HttpGet('https://raw.githubusercontent.com/CMD-X/CMD-X/master/Source'))()", Kategori = "Genel"},
    {Isim = "Fly GUI V3 (Gelişmiş Mobil Uçuş)", Komut = "loadstring(game:HttpGet('https://raw.githubusercontent.com/XNEOFF/Fly-Gui-V3/main/Fly-Gui-V3.lua'))()", Kategori = "Genel"},
    {Isim = "Blox Fruits: Hoho Hub v2 (Oto Kasılma)", Komut = "loadstring(game:HttpGet('https://raw.githubusercontent.com/acsu123/HOHO_H/main/Loading_v2'))()", Kategori = "Oyunlar"},
    ...
    {Isim = "Blox Fruits: W-Azure Hub", Komut = "loadstring(game:HttpGet('https://api.luoguard.org/v3/id/wazure'))()", Kategori = "Oyunlar"},
    ...
    {Isim = "BedWars: Vape V4 PvP Hack", Komut = "loadstring(game:HttpGet('https://raw.githubusercontent.com/7GrandDadPGN/VapeV4ForRoblox/main/NewMainScript.lua'))()", Kategori = "Oyunlar"},
    ...
    {Isim = "Fling GUI v2 (Oyuncuları Fırlatır)", Komut = "loadstring(game:HttpGet('https://raw.githubusercontent.com/FlingCommunity/FlingGui/main/Source.lua'))()", Kategori = "Troll"},
    {Isim = "Shedletsky R6 Animasyon Paketi", Komut = "loadstring(game:HttpGet('https://raw.githubusercontent.com/TrollScripts/R6Anim/main/Source.lua'))()", Kategori = "Troll"},
    {Isim = "Dex Explorer V4 (Dosya Gezgini)", Komut = "loadstring(game:HttpGet('https://raw.githubusercontent.com/infyiff/backup/main/dex.lua'))()", Kategori = "Siber"},
...
CreateActionButton(PlayerPage, "14 🛠️ BTools: Engel Silme Silahları", function() Instance.new("HopperBin", game.Players.LocalPlayer.Backpack).BinType = 1 Instance.new("HopperBin", game.Players.LocalPlayer.Backpack).BinType = 2 Instance.new("HopperBin", game.Players.LocalPlayer.Backpack).BinType = 4 end)
...
CreateActionButton(PlayerPage, "18 🧼 Sohbet Alanına Sistem Mesajı Gönder", function() game:GetService("StarterGui"):SetCore("ChatMakeSystemMessage", {Text = "[ FreaX HUB SYSTEM ]", Color = Color3.fromRGB(0, 255, 140)}) end)
